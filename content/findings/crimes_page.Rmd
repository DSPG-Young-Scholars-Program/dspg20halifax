...
rates_by_gender_system %>%
  ...
  labs(color = "Gender", title = "Prison Incarceration Rate", y = "Incarcerated Individuals per 1,000 Residents\n", x = "")  +
...
rates_by_gender_system %>%
  ...
  gghighlight(county_name == "Halifax County", use_direct_label = FALSE, calculate_per_facet = TRUE, unhighlighted_params = list(alpha = 0.2)) +
  scale_y_continuous(limits = c(0, scale_max)) +
  labs(color = "Gender", title = "Jail Incarceration Rate", subtitle = "", y = "Incarcerated Individuals per 1,000 Residents\n", x = "")  +
  facet_wrap(gender~.) +
...
On average, 2,081 crimes came to the attention of law enforcement within the 10-year period between 2010 and 2019 in Halifax County.
...
ggplot(filter(va_crime_per_cap, county_cap == "HALIFAX"), aes(x = incident_year, 
  ...
  labs(x = NULL,
       y = "Number of Crimes per Per 1000 Residents",
...
The following figures compare the average number of crimes (per 1000 residents) law enforcement was alerted to across all Virginia counties from 2010 to 2019, with darker colors indicating higher crime rates and vice versa.

<br>

#### Map of All Crimes

Halifax County, compared to other Virginia counties, was around the median across all of Virginia in total crimes per 1000 residents that law enforcement were alerted to. The same conclusion holds when examining the average number of crimes per 1000 residents by race. 
...
mapping_data %>% 
  ...
  addLegend("bottomright", pal = leaflet_scale, values = ~year_crime_per_1000,
            title = "Yearly Crimes (per 1000 Residents)",
            opacity = .8)
...
Comparing just drug related crimes across Virginia counties, Halifax County was again close to the median levels of drug crimes per 1000 residents that law enforcement are alerted to across all of Virginia. The same conclusion holds when examining the average number of drug related crimes by race. 
...
mapping_data %>% 
  ...
  addLayersControl(
    ...
    options = layersControlOptions(collapsed = FALSE)) %>% 
  addLegend("bottomright", pal = leaflet_scale, values = ~year_crime_per_1000,
            title = "Yearly Drug Crimes (per 1000 Residents)",
            opacity = .8)
