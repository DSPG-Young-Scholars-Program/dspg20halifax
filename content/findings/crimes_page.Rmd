...
rates_by_gender_system %>%
  ...
  labs(color = "Gender", title = "Prison Incarceration Rate", y = "Incarcerated Individuals per 100,000\n", x = "\nYear")  +
...
rates_by_gender_system %>%
  ...
  gghighlight(county_name == "Halifax County", use_direct_label = FALSE, calculate_per_facet = TRUE, unhighlighted_params = list(alpha = 0.2)) +
  scale_y_continuous(limits = c(0, scale_max)) +
  labs(color = "Gender", title = "Jail Incarceration Rate", subtitle = "", y = "Incarcerated Individuals per 100,000\n", x = "\nYear")  +
  facet_wrap(gender~.) +
