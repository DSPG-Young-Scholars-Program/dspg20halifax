...
In order to properly understand the complicated relationship between incarceration, recidivism, and employment in Halifax, more data is required. Ideally, we would have an understanding of employment rates for those who are formerly incarcerated, as well as information on the wages of these jobs to understand if the jobs the formerly incarcerated are able to get pay enough to survive. 
