...
description: "How stable are family units?"
weight: 6
draft: false
...
In 2017, the rate of teen pregnancy (per 1,000 women) was 18.8 in the United States. In the same time period, the rate of teen pregnancy (per 1,000 women) in Virginia was 15 and in Halifax county the rate was estimated at 30.8(National Center for Health Statistics, n.d.). This put Halifax at the 24th highest rate of teen births out of 134 counties in Virginia. While the number of teen births has been declining since 2003, the fact that Halifax was in the upper portion of the distribution indicates the potential for effective interventions on this factor.
>>>>>>> 61273ed55e8dd393d6c7ff76d46aac4ec1cfcfe6
...
va_birth_rates %>%
  ggplot() +
  geom_line(aes(x = Year, y = Birth_Rate, group = County), color = "#FC4444", lwd = 1.1) +
  gghighlight(County == "Halifax", use_direct_label = FALSE, unhighlighted_params = list(alpha = 0.2)) +
...
<<<<<<< HEAD
Teen pregnancy can have drastic effects on the individual, interpersonal, and the school/work environments of both the mother and their child, as well as costly effects on society. As a result of their pregnancy, teen mothers are at elevated risk for low academic achievement, dropping out of high school, being unemployed, using public assistance, and being in poverty than non-pregnant women of the same age (About Teen Pregnancy | CDC, n.d.). Children of teen mothers are also at elevated risk for low academic achievement, low health and behavioral outcomes, high unemployment, and delinquency compared to children of non-teen mothers (About Teen Pregnancy | CDC, n.d.). Children of teenage mothers are also more likely to become teen parents (Pregnancy Prevention | Youth.gov, n.d.). Thus, it is will be important to continue to investigate how to mitigate teen births.  
=======
```{r, fig.height = 4}
...
Given that these areas tend to be rural (a pattern consistent with current research)[^CDC2], efforts to reduce teen birth rates that focus on this cultural context may be particularly valuable. Important to note is that Halifax county has only one publicly funced clinic and no federally qualified health cetners to aid in female contraception usage(Guttmacher Data Center, n.d.). By the age of 18, a women is more than 3 times as likely to have had a teen birth if they do not reliably use contraception (Products - Data Briefs - Number 209 - July 2015.). Because of these few resources, the importance of effectively connecting young women to these resources becomes paramount, and is a role that could potentially be filled by the proposed FCSA.
...
plot <- ggplot() +
  ...
  scale_color_manual(labels = c("U.S.", "Virginia", "Halifax County"), values = c("#f1f1f0", "#c1c5df", "#FC4444"), na.translate=FALSE) +
...
### Future Findings
To better assess teen pregnancy it would be beneficial to have data that tells how many incarcerated persons are teen parents or are children of teen parents. This could better show how delinquency and teen pregnancy are connected. It would also be helpful to have more data regarding the economic costs of teen pregnancy on the national, state, and local levels. 

_Uncited references?_
...
[^CDC2]: Products - Data Briefs - Number 264 - November 2016. (2016, November). Center for Disease Control and Prevention. https://www.cdc.gov/nchs/products/databriefs/db264.htm#:%7E:text=From%202007%20through%202015%2C%20the%20rates%20in%20these%20counties%20were,greater%20than%20the%20national%20rate.