...
```{r, echo = FALSE}
knitr::opts_chunk(echo = FALSE, warning = FALSE, message = FALSE, fig.width = 15, fig.height = 10)
...
Importantly, these values do not incorporate the many other operational expenses and indirect costs related to incarceration, including court proceedings, costs related to foster care, and costs for substance abuse treatment (among many others).
