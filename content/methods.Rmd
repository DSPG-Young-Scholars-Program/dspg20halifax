...
Overall, the course of this project revealed many of the difficulties inherent in exploring the topic of incarceration and recidivism. The latter in particular requires nuanced data that either are collected only very intermittently at the national level (for instance, the Bureau of Justice Statistics' recidivism analysis tool) (CITE) or simply do not exist.

Given the sensitive nature of the topic, substituting proxies for these missing data can easily risk simply capturing the biases that already exist in the criminal justice system.
